...
# Jupyter Notebooks Part 1 and 2
...
```
    ...
    inflam_inflam_inflam_001 weight in kilograms: 60
...
```python
print('maximum imflammation for patient 2:', numpy.amax(data[2, :]))
```

    maximum imflammation for patient 2: 19.0
...
if max_inflammation_0 ==0 and max_inflammation_20 == 20:
    print('Saspitctious looking maxima!')
```

    Saspitctious looking maxima!
...
def fahr_to_celsius(temp):
    ...
    # a new variable. This code does that same thing as the previous function but it is more 
    # explicit in explaining how the return works
    return ((temp - 32)*(5/9))
```
...
```python
# START OF PART 3 FUNCTIONS FOR THE FINAL
```
...
```python
#offset mean(data, target_mean value);
# return a new array containing the orignial data with its mean offset to match the deisred value
...
```python
def offset_mean(data, target_mean_value):
    """Return a new array contianing the original data with its mean offset to match the desired value
...
```python
# START OF PART 4 OF FUNCTIONS FOR THE FINAL
```
...
def offset_mean(data, target_mean_value = 0.0):
    """Return a new array contianing the original data with its mean offset to match the desired value, (0 by defualt)
...
```
    ...
    <ipython-input-6-64290abb390d> in <module>
          2 total = 0.0
...
```
    ...
    <ipython-input-12-07e1bfd52af7> in <module>
...
```
    ...
    <ipython-input-13-36b45d872f48> in <module>
...
```
    ...
    <ipython-input-16-b96557269f9b> in <module>
...
```
    ...
    
...
```
    ...
    Enter the name of the input file: Ubiquitin



```python
 # Open the RNA file and read the sequence
...
```
     ...
     SDEKKGGRPSTQPKARPGQRRASKTRSTHPRKRERHATGRTPAGGARDGQPTTRTTPDPRRGGGRHHEUGUCDQQQTGRPKATKRREUGUCGDRAHNRRPGQDNAAPARQEAHTRGSEUGUCNATRPAGPQQGAPATDSPQRERHPTRGEUGUCEUGUCEUGUCGDTTRTSSRRGAQ
